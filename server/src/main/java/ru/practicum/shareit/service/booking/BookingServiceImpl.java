...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public List<Booking> getBookingsByUser(Long userId, String stateString, Integer from, Integer size) {
        ...
        List<Booking> allBookings = strategy.findBookings(userId);
        ...
        return allBookings.subList(start, end);
    }


    @Override
    public List<Booking> getBookingsByOwner(Long userId, String stateString, Integer from, Integer size) {
        userRepository.findById(userId)
                .orElseThrow(() -> new NotFoundException("Пользователь с id ".concat(String.valueOf(userId)).concat(" не найден")));
